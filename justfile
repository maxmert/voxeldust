...
tier_a := "-p vd-recipe -p vd-seed -p vd-terrain -p vd-core -p vd-physics -p vd-devproto -p vd-wire -p vd-sim -p vd-node -p vd-connection-plane -p vd-harness -p vd-client -p vd-client-harness"
