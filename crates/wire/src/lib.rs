...
//!    closed set is 21 arms: `Ghost | Transfer | Directory | Saga | SagaAck | DirectoryReply
...
//!    CrossingRequest | TransientCrossingRequest | TransientCrossingGrant | CrossingAborted` (P0
...
//!    spatial transfer-trigger crossing arms — INERT, planted ahead of their consumer routes). RESERVED
