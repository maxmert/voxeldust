//! Shard-orchestration primitives.
//!
//! Lifted verbatim from the prior `voxeldust_core::shard_types` module. These
//! identifiers are the universal vocabulary used by every shard, the
//! orchestrator, the gateway, and the client; placing them at the bottom of
//! the crate graph keeps them stable across refactors of higher layers.
